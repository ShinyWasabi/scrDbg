...
namespace scrDbg
{
    ...
    std::optional<int> ScriptDisassembler::UpdateStringIndex(const std::vector<uint8_t>& code, uint32_t pc)
    {
        ...
        case rage::scrOpcode::PUSH_CONST_U8:  return ScriptHelpers::ReadByte(code, pc + 1);
        case rage::scrOpcode::PUSH_CONST_S16: return ScriptHelpers::ReadS16(code, pc + 1);
        case rage::scrOpcode::PUSH_CONST_U24: return ScriptHelpers::ReadU24(code, pc + 1);
        case rage::scrOpcode::PUSH_CONST_U32: return ScriptHelpers::ReadU32(code, pc + 1);
