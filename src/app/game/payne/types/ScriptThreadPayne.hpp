...
namespace scrDbgApp
{
    class ScriptThreadPayne : public ScriptThread
    {
    public:
        ScriptThreadPayne(uintptr_t base = 0)
            : m_Base(base)
        {
        }
        ...
        uint32_t GetTypedFlags() const override;
    ...
    private:
        ...
        static constexpr size_t STACK_SIZE = 0x2C;
        static constexpr size_t TYPED_FLAGS = 0x38;
        static constexpr size_t STACK = 0x40;
        static constexpr size_t KILL_REASON = 0x54;
        static constexpr size_t SCRIPT_NAME = 0x84;
